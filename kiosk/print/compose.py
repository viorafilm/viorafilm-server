...
_FALLBACK_SLOT_NORMALIZED: dict[str, list[tuple[float, float, float, float]]] = {
    "2641": [
        (0.0667, 0.02, 0.3617, 0.2078),
        (0.5683, 0.02, 0.36, 0.2078),
        (0.0667, 0.2478, 0.3617, 0.2089),
        (0.5683, 0.2478, 0.36, 0.2089),
        (0.0667, 0.4767, 0.3617, 0.2111),
        (0.5683, 0.4767, 0.36, 0.2111),
        (0.0667, 0.7078, 0.3617, 0.2078),
        (0.5683, 0.7078, 0.36, 0.2078),
    ],
    "6241": [
        (0.02, 0.07, 0.21, 0.3633),
        (0.2506, 0.07, 0.2061, 0.3633),
        (0.4772, 0.07, 0.21, 0.3633),
        (0.7078, 0.07, 0.2072, 0.3633),
        (0.02, 0.5692, 0.21, 0.3592),
        (0.2506, 0.5692, 0.2061, 0.3592),
        (0.4772, 0.5692, 0.21, 0.3592),
        (0.7078, 0.5692, 0.2072, 0.3592),
    ],
    "4641": [
        (0.07, 0.09, 0.39, 0.38),
        (0.54, 0.09, 0.39, 0.38),
